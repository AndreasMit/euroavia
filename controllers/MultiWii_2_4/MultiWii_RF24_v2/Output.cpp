...
void writeMotors() { // [1000;2000] => [125;250]
   ...
   */   
//  motor[0] = (motor[0]-900) << 1;
//  motor[1] = (motor[1]-900) << 1;
//  motor[2] = (motor[2]-900) << 1;
//  motor[3] = (motor[3]-900) << 1;
...
void mixTable() {
  ...
  #elif defined( QUADX ) //!!!! changed these so that i don't have to change the order of the pins and thus change the special settings about the softpwm pins 5,6
    motor[1] = PIDMIX(-1,+1,-1); //REAR_R
    motor[2] = PIDMIX(-1,-1,+1); //FRONT_R
    motor[0] = PIDMIX(+1,+1,+1); //REAR_L
