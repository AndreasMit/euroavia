...
'''
Usage Syntax of the main functions:
...
def fftTransform(signal, fs, rms_flag=False):
...
def plotData(figNum, x, y, label = None, lw=1.5, c="k", timeFlag=False, fftFlag=False, hilbFlag=False, multiSelectFlag=False, title=None, alpha=1):
