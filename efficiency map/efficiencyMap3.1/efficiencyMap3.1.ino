...
/*
We measure :
  -airspeed: using pittot
  -thrust: using a load cell. Comm I2C
  -voltage: voltage divider
  -current: shunt resistor with amplifier. Comm with I2C.
  -rpm: using IR sensor from a 2nd arduino. Comm with I2C.
  -pressure and temperature (I2C)
*/
...
#define voltage_pin A2 //4th pin or A0 because it does not need 5v.
HX711 scale;
File myFile;
Servo motor;
...
//  data.rpm = Wire.read();    // read one character from the I2C
